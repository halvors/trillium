...
pub trait Handler: Send + Sync + 'static {
    ...
    /**
    predicate function answering the question of whether this Handler would like to take ownership
    of the negotiated Upgrade. If this returns true, you must implement [`Handler::upgrade`]. The
    first handler that responds true to this will receive ownership of the
    ...
    */
    ...
    /**
    This will only be called if the handler reponds true to [`Handler::has_upgrade`] and will only
    be called once for this upgrade. There is no return value, and this function takes exclusive
    ownership of the underlying transport once this is called. You can downcast the transport to
    whatever the source transport type is and perform any non-http protocol communication that has
    been negotiated. You probably don't want this unless you're implementing something like
    websockets. Please note that for many transports such as `TcpStreams`, dropping the transport
    ...
    */
    ...
    /**
    Customize the name of your handler. This is used in Debug implementations. The default is the
    type name of this handler.
    */
